...
export function Poll({ pollName }: { pollName: string }) {
  ...
  return (
    <div className="w-full">
      <div className="ml-auto mr-auto flex flex-col space-y-8 lg:w-2/3 2xl:w-1/2">
        ...
        <Reorder.Group
          values={
            options as { id: string; name: string; checkedBy: string[] }[]
          }
